...
public class HotSwapURLClassLoader extends URLClassLoader {
	...
	//工程class类所在的路径
	public static String projectClassPath = "/Users/iss/sourceCode/spark/sjmsDemo1/target/classes/";
	
	//所有的测试的类都在同一个包下
	public static String packagePath = "xmht/jvm/load/hotswap/";
	...
	public static void main(String[] args) {
		ClassLoader parent = HotSwapURLClassLoader.getClassLoader().getParent();
