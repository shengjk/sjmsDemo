...
5.对每个节点，从该节点到其他叶子节点的所有路径上包含相同数据的黑节点
...
1.新插入节点的父节点是黑色的，不用调整
2.新插入节点的父节点是红色的
    叔叔节点是空的，旋转+变色 (G+P 变色)
    叔叔节点是红色的，父节点和叔叔节点全部变为黑色，祖父节点变为红色
    叔叔节点是黑色的，旋转+变色 (G+P 变色)
```
